...
chromedriver_path = "/Users/robertsonkla/Documents/Coding_Projects/Python/Python_Portfolio/Custom_Web_Scraper" \
                    "/chromedriver"
driver = webdriver.Chrome(executable_path=chromedriver_path)

forms_url = "https://forms.gle/ZC4jLjQbDtpkZ6Ki9"

zoopla_url = "https://www.zoopla.co.uk/for-sale/property/se1/?page_size=25&view_type=list&q=SE1%20%20Waterloo%2C" \
             "%20Bermondsey%2C%20South%20Bank%2C%20The%20Borough%2C%20...&radius=0&results_sort=newest_listings" \
...
#
response = requests.get(url=zoopla_url)
# # print(response.text)
price_results = response.text
#
soup = BeautifulSoup(price_results, 'html.parser')
driver.get(forms_url)
print(soup.title)
#
full_price = soup.find_all("p", class_="c-bTssUX")
...
prop_soup = soup.find_all('h3', class_='c-eFZDwI')
prop_addresses = [address.get_text() for address in prop_soup]
# test
print(prop_addresses)
#
start_link = 'https://zoopla.co.uk/for-sale/b'
#
